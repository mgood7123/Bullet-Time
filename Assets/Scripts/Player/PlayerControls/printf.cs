...
public static class printfTools
{
	public static class Tools
	{
		...
		#endregion
		#region fprintf
		public static void fprintf( /* give fprintf the equivilant of a C function pointer */ Action<string> Function, string Format, params object[] Parameters )
		{
			Function( Tools.sprintf( Format, Parameters ) );
		}
		#endregion
		#region sprintf
